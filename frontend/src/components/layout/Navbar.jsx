  ...
  return (
    <nav className="fixed top-0 w-full h-[64px] bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 z-50 px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        <Link to="/login" className="text-[14px] font-semibold text-slate-600 dark:text-slate-300 px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded">Sign In</Link>
        <Link to="/login" className="bg-primary text-white text-[14px] font-bold px-5 py-2 rounded-lg hover:bg-blue-600 transition-all inline-block">Get Started Free</Link>
      </div>
    </nav>
  );
};
