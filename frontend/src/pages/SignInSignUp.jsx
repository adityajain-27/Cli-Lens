        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="flex border-b border-slate-200 mb-8">
            <button
              ...
              className={`flex-1 pb-4 text-sm font-semibold border-b-2 ${
                isSignIn ? 'border-primary text-primary' : 'border-transparent text-slate-500 hover:text-slate-700'
              }`}
            >
              Sign In
            </button>
          ...
          {isSignIn ? (
            <form className="space-y-6">
              ...
              <Link
                to="/dashboard"
                className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg transition-colors shadow-sm flex items-center justify-center cursor-pointer"
              >
                Continue
              </Link>
            ...
            <form className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  <button
                    className="flex-1 py-2 px-4 rounded-full border border-primary bg-primary text-white text-sm font-medium transition-all"
                    type="button"
                  >
                    Public User
                  </button>
                  <button
                    className="flex-1 py-2 px-4 rounded-full border border-slate-200 text-slate-600 text-sm font-medium hover:border-primary transition-all"
                    type="button"
                  >
                    Researcher
                  </button>
              ...
              <Link
                to="/dashboard"
                className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg transition-colors flex items-center justify-center cursor-pointer"
              >
                Create Account
              </Link>
            </form>
          ...
          <div className="mt-8 flex justify-center gap-6">
            ...
            <button className="p-2 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors text-slate-900">
